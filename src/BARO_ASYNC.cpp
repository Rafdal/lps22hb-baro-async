...
void LPS22HB_Async::dump_registers(Stream &stream)
{
    ...
    stream.print(F("\tINTERRUPT_CFG = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_INTERRUPT_CFG_REG));
    ...
    stream.print(F("\tCTRL_REG3     = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_CTRL3_REG));
    stream.print(F("\tFIFO_CTRL     = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_CTRL_FIFO_REG));
    stream.print(F("\tREF_P_XL      = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_REF_P_XL_REG));
    stream.print(F("\tREF_P_L       = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_REF_P_L_REG));
    stream.print(F("\tREF_P_H       = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_REF_P_H_REG));
    stream.print(F("\tRPDS_L        = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_RPDS_L_REG));
    stream.print(F("\tRPDS_H        = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_RPDS_H_REG));
    stream.print(F("\tRES_CONF      = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_RES_CONF_REG));
    stream.print(F("\tINT_SOURCE    = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_INTERRUPT_SOURCE_REG));
    stream.print(F("\tFIFO_STATUS   = "));
    prettyPrintBIN(stream, i2cRead(0x25));
    stream.print(F("\tSTATUS        = "));
    prettyPrintBIN(stream, i2cRead(LPS22HB_STATUS_REG));
}
